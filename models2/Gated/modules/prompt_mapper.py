"""Prompt mapper that produces gating controls from multimodal features."""
...
class PromptMapper(nn.Module):
    """Encode EfficientNet/text embeddings into controller states for gating modules."""
    ...
    def forward(
        ...
        """Produce controller tokens and global state.
